if (keyboard_check(ord("R")) && ((room == room_battle) || (room == room_floweyx)))
{
    restart_timer += 1
    ...
    restart_timer = 0
if (keyboard_check(ord("G")) && ((room == room_battle) || (room == room_floweyx)))
{
    trans_timer += 1
    draw_set_font(fnt_small)
    draw_set_color(c_red)
    ...
    trans_timer = 0
if (keyboard_check(ord("S")) && ((room != room_battle) && (room != room_floweyx)))
{
    draw_set_font(fnt_small)
...
if (keyboard_check_pressed(ord("T")) && ((room != room_battle) && (room != room_floweyx)))
{
    if (settingsMenu == 1)
    {
        settingsMenu = 0
